...
public class Map extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        beachInfo = "Continue your fishing journey at the beach, and try to catch the elusive Perch";
        dockInfo = "The dock is a great starting point for catching your first fish, the friendly Trout!";
